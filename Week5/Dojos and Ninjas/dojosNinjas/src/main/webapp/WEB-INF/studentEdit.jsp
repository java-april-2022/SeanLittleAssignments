...
<body>
	...
	<div class="card-body bg-secondary text-light">
		<div class="card-header bg-dark">
			<h1 class="display-4 survey text-info">Edit This Student</h1>
			<div class="card-body bg-secondary text-light">

				<form:form action="/update/student/${editStudent.id}" method="put" modelAttribute="editStudent">
					<p>
					...
					<button class="btn btn-info btn-outline-dark">Update Student</button>
